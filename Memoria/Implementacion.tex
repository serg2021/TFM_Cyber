...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{Figuras/Implementacion/Server\_HTTP.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{Figuras/Implementacion/Colab\_1.png}
  \label{fig:colab-1}
  \caption{Fastbook}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{Figuras/Implementacion/Colab\_2.png}
  \label{fig:colab-2}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{Figuras/Implementacion/Colab\_3.png}
  \label{fig:colab-3}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{Figuras/Implementacion/Colab\_4.png}
  \label{fig:colab-4}
...
El siguiente argumento es el tamaño del lote de imágenes que se van a entrenar en cada iteración. Para cada iteración se van a cotejar todas las imágenes, sin embargo, se tienen que distribuir de forma diferente en cada una para que haya una cierta aleatoriedad y que los modelos no aprendan siempre con las mismas imágenes en un mismo lote. Es decir, si queremos que el sistema prospere tenemos que forzar a que aprenda de todas las imágenes, no de sólo unas pocas que sean siempre las mismas. Eso lo conseguimos concretando este argumento y una instrucción que veremos más adelante.
